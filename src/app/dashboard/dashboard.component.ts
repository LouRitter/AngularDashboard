...
import { dashboardCards } from '../dashboard-card/dashboard-cards';
...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  constructor(private cd: ChangeDetectorRef, private cfr: ComponentFactoryResolver, private dashboardService: DashboardService) {}
